...
INSERT INTO coach (coach_name, nationality) VALUES
('Coach Club 1', 'French'),
...
INSERT INTO club (club_name, acronym, year_creation, stadium, coach_id) VALUES
('Club 1', 'C1', 1902, 'Stade 1', (SELECT coach_id FROM coach WHERE coach_name = 'Coach Club 1')),
...
-- Club 1 players
INSERT INTO player (player_name, number, position, nationality, age, club_id) VALUES
      ('Gardien 1', 1, 'GOAL_KEEPER', 'French', 30, (SELECT club_id FROM club WHERE club_name = 'Club 1')),
...
-- Club 2 players
INSERT INTO player (player_name, number, position, nationality, age, club_id) VALUES
      ('Gardien 2', 1, 'GOAL_KEEPER', 'Spanish', 21, (SELECT club_id FROM club WHERE club_name = 'Club 2')),
...
-- Club 3 players
INSERT INTO player (player_name, number, position, nationality, age, club_id) VALUES
      ('Gardien 3', 1, 'GOAL_KEEPER', 'German', 28, (SELECT club_id FROM club WHERE club_name = 'Club 3')),
...
INSERT INTO season (alias, status, year) VALUES
                 ('Saison 2024', 'FINISHED', 2024),
